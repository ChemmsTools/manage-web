...
export default class Header extends React.Component {
  ...
  // 更新 state 中当前选定的对象
  updateCurrentObj = () => {
    const { tools, components } = this.state

    if (SELECTED) {
      this.setState({ cur_obj: tools })
    } else {
      this.setState({ cur_obj: components })
    }
